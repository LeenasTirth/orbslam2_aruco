...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    // output marker info
    /*if (mCurrentFrame.hasMarker){
        cout<<"TrackReferenceKeyFrame: Find "<<mCurrentFrame.markerIds.size()<<" markers in current frame. The Ids are: ";
        set<int>::iterator it;
        for (it = mCurrentFrame.markerIds.begin(); it != mCurrentFrame.markerIds.end();++it){
            cout<<*it<<" ";
        }
        cout<<endl;
    }*/
...
bool Tracking::TrackWithMotionModel()
{
    // output marker info
    /*if (mCurrentFrame.hasMarker){
        cout<<"TrackWithMotionModel: Find "<<mCurrentFrame.markerIds.size()<<" markers in current frame. The Ids are: ";
        set<int>::iterator it;
        for (it = mCurrentFrame.markerIds.begin(); it != mCurrentFrame.markerIds.end();++it){
            cout<<*it<<" ";
        }
    ...
    if (mCurrentFrame.hasMarker){
        ...
        for (it = mCurrentFrame.markerIds.begin(); it != mCurrentFrame.markerIds.end();++it){
            if (!mpMap->MarkerIds.count(*it)){
                cout<<"Marker "<<*it<<" is not in the map, add current frame to keyframe."<<endl;
                return true;
            }
        }
    }
